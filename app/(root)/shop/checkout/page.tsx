import { CheckoutFormComponent } from "@/components";

const CheckoutPage = () => {
  return (
    <div className="container mx-auto pt-16 pb-6">
      <div className="flex flex-col md:flex-row lg:flex-row justify-between">
        <div className="flex flex-row w-full nd:w-1/2 lg:w-1/2 justify-between">
          <h1 className="text-3xl text-white font-bold mb-6">Checkout</h1>
        </div>

        <div className="flex flex-row w-full nd:w-1/2 lg:w-1/2 justify-center md:justify-end lg:justify-end">
      ...
      <div className="flex flex-col md:flex-row lg:flex-row justify-between w-full mt-6">
