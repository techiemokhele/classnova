...
const TermsOfServicePage = () => {
  return (
    <div className="flex flex-col container py-16 text-white">
      <h1 className="font-extrabold mb-4 text-[32px]">Terms and Conditions</h1>
      <p className="text-[10px] mb-4">Last updated: June 17, 2024</p>
      <p className="text-[10px] mb-4">
        Please read these terms and conditions carefully before using Our
        Service.
      </p>
      <h2 className="mb-4 font-bold  text-[28px]">
        Interpretation and Definitions
      </h2>
      <h3 className="mb-4 font-bold text-[20px]">Interpretation</h3>
      <p className="text-[10px] mb-4">
      ...
      <h2 className="mb-4 font-bold  text-[28px]">Acknowledgment</h2>
      <p className="text-[10px] mb-4">
      ...
      <h2 className="mb-4 font-bold  text-[28px]">Links to Other Websites</h2>
      <p className="text-[10px] mb-4">
      ...
      <h2 className="mb-4 font-bold  text-[28px]">Termination</h2>
      <p className="text-[10px] mb-4">
      ...
      <h2 className="mb-4 font-bold  text-[28px]">Limitation of Liability</h2>
      <p className="text-[10px] mb-4">
      ...
      <h2 className="mb-4 font-bold  text-[28px]">Governing Law</h2>
      <p className="text-[10px] mb-4">
      ...
      <h2 className="mb-4 font-bold  text-[28px]">Disputes Resolution</h2>
      <p className="text-[10px] mb-4">
      ...
      <h2 className="mb-4 font-bold  text-[28px]">Severability and Waiver</h2>
      <h3 className="mb-4 font-bold text-[20px]">Severability</h3>
      <p className="text-[10px] mb-4">
      ...
      <h3 className="mb-4 font-bold text-[20px]">Waiver</h3>
      <p className="text-[10px] mb-4">
      ...
      <h2 className="mb-4 font-bold  text-[28px]">Contact Us</h2>
      <p className="text-[10px] mb-4">
