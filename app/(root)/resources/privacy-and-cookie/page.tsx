const PrivacyAndCookiePage = () => {
  return (
    <div className="flex flex-col container py-16 text-white">
      <h1 className="font-extrabold mb-4 text-[32px]">Privacy Policy</h1>
      ...
      <p className="text-xs mb-4">For the purposes of this Privacy Policy:</p>
      ...
      <h3 className="mb-4 font-bold text-[20px]">Types of Data Collected</h3>
      <h4 className="font-bold mb-4">Personal Data</h4>
      <p className="text-xs mb-4">
      ...
      <ul className="list-disc px-8 mb-4">
        <li>
          <p className="text-xs mb-4">Email address</p>
        </li>
        <li>
          <p className="text-xs mb-4">First name and last name</p>
        </li>
        <li>
          <p className="text-xs mb-4">Phone number</p>
        </li>
        <li>
          <p className="text-xs mb-4">
        ...
        <li>
          <p className="text-xs mb-4">Usage Data</p>
        </li>
      </ul>
      <h4 className="font-bold mb-4">Usage Data</h4>
      <p className="text-xs mb-4">
      ...
      <h4 className="font-bold mb-4">Tracking Technologies and Cookies</h4>
      <p className="text-xs mb-4">
      ...
      <ul className="list-disc px-8 mb-4">
        <li>
          ...
          <p className="text-xs mb-4">Type: Session Cookies</p>
          <p className="text-xs mb-4">Administered by: Us</p>
          <p className="text-xs mb-4">
        ...
        <li>
          ...
          <p className="text-xs mb-4">Type: Persistent Cookies</p>
          <p className="text-xs mb-4">Administered by: Us</p>
          <p className="text-xs mb-4">
      ...
      <h3 className="mb-4 font-bold text-[20px]">Use of Your Personal Data</h3>
      <p className="text-xs mb-4">
      ...
      <h3 className="mb-4 font-bold text-[20px]">Delete Your Personal Data</h3>
      <p className="text-xs mb-4">
      ...
      <h4 className="font-bold mb-4">Business Transactions</h4>
      <p className="text-xs mb-4">
      ...
      <h4 className="font-bold mb-4">Law enforcement</h4>
      <p className="text-xs mb-4">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="font-bold mb-4">Other legal requirements</h4>
      <p className="text-xs mb-4">
      ...
      <h2 className="mb-4 font-bold  text-[28px]">Children's Privacy</h2>
      <p className="text-xs mb-4">
      ...
      <h2 className="mb-4 font-bold">Changes to this Privacy Policy</h2>
      <p className="text-xs mb-4">
...
export default PrivacyAndCookiePage;
