const PrivacyAndCookiePage = () => {
  return (
    <div className="flex flex-col container py-16 text-white">
      ...
      <ul className="list-disc px-8 mb-4">
        <li>
          <p className="text-[10px] mb-4">Email address</p>
        </li>
        <li>
          <p className="text-[10px] mb-4">First name and last name</p>
        </li>
        <li>
          <p className="text-[10px] mb-4">Phone number</p>
        </li>
        <li>
          <p className="text-[10px] mb-4">
        ...
        <li>
          <p className="text-[10px] mb-4">Usage Data</p>
        </li>
      </ul>
      ...
      <ul className="list-disc px-8 mb-4">
        <li>
          ...
          <p className="text-[10px] mb-4">Type: Session Cookies</p>
          <p className="text-[10px] mb-4">Administered by: Us</p>
          <p className="text-[10px] mb-4">
        ...
        <li>
          ...
          <p className="text-[10px] mb-4">Type: Persistent Cookies</p>
          <p className="text-[10px] mb-4">Administered by: Us</p>
          <p className="text-[10px] mb-4">
